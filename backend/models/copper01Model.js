...
const copper01Schema = new Schema({
    ...
    rng1Average: {type: Number, default: function() {
        return (this.rng1b + this.rng1m + this.rng1t) / 3
    }},
    ...
    rng2Average: {type: Number, default: function() {
        return (this.rng2b + this.rng2m + this.rng2t) / 3
    }},
    ...
    rng3Average: {type: Number, default: function() {
        return (this.rng3b + this.rng3m + this.rng3t) / 3
    }},
    ...
    rng3odAverage: {type: Number, default: function() {
        return (this.rng3od1 + this.rng3od2 + this.rng3od3 + this.rng3od4) / 4
    }},
    ...
    rng4odAverage: {type: Number, default: function() {
        return (this.rng4od1 + this.rng4od2 + this.rng4od3 + this.rng4od4) / 4
    }}
}, { timestamps: true })
