    ...
    return (
        <div className="anode-details">
            <h4>Batch ID: {copper01.batchID} &emsp;&emsp; Set #: {copper01.set} &emsp;&emsp; Date: {format(new Date(copper01.createdAt), 'MM-dd-yyyy')}</h4>
                    ...
                    <p><strong>Pass Post:</strong> {copper01.postPass}
                    <strong>Sponge Pass:</strong> {copper01.spongePass}</p>
            
                    <p><strong>Rng1b:</strong> {copper01.rng1b}
                    <strong>Rng1m:</strong> {copper01.rng1b}
                    <strong>Rng1t:</strong> {copper01.rng1t}
                    <strong>Rng1 Avg:</strong> {copper01.rng1Average}</p>
