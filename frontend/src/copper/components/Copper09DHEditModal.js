...
const Copper09DHEditModal = ({ copper09DH, closeModal }) => {
  ...
  const [editedData, setEditedData] = useState({
    ...
    set: copper09DH.set,
    postPass: copper09DH.postPass,
    spongePass: copper09DH.spongePass,
    rng1b: copper09DH.rng1b,
    rng1m: copper09DH.rng1m,
    rng1t: copper09DH.rng1t,
    rng1Average: copper09DH.rng1Average,
    rng2b: copper09DH.rng2b,
    rng2m: copper09DH.rng2m,
    rng2t: copper09DH.rng2t,
    rng2Average: copper09DH.rng2Average,
    rng3b: copper09DH.rng3b,
    rng3m: copper09DH.rng3m,
    rng3t: copper09DH.rng3t,
    rng3Average: copper09DH.rng3Average,
    rng4b: copper09DH.rng4b,
    rng4m: copper09DH.rng4m,
    rng4t: copper09DH.rng4t,
    rng4Average: copper09DH.rng4Average,
    rng1od1: copper09DH.rng1od1,
    rng1od2: copper09DH.rng1od2,
    rng1odAverage: copper09DH.rng1odAverage,
    rng2od1: copper09DH.rng2od1,
    rng2od2: copper09DH.rng2od2,
    rng2odAverage: copper09DH.rng2odAverage,
    rng3od1: copper09DH.rng3od1,
    rng3od2: copper09DH.rng3od2,
    rng3odAverage: copper09DH.rng3odAverage,
    rng4od1: copper09DH.rng4od1,
    rng4od2: copper09DH.rng4od2,
    rng4odAverage: copper09DH.rng4odAverage
  });
  ...
  const handleSave = async () => {
    try {
      ...
      if (response.ok) {
        // Dispatch the "UPDATE_COPPER09DH" action with the updated copper09DH data
        dispatch({ type: "UPDATE_COPPER09DH", payload: json });
    ...
    <div className="modal">
      <div className="modal-content">
        <div className="modal-scrollable">
          <h2>Edit Copper 09DH</h2>
          <label>
            <strong>Batch ID: {copper09DH.batchID} &emsp;&emsp;&emsp;&emsp; Set #: {copper09DH.set}</strong>
          </label>
          <hr/>
          <label>
          Pass Post?
...
export default Copper09DHEditModal;